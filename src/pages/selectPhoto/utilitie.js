    ...
    YAHOO.util.Event = function() {
        ...
        return {
            ...
            purgeElement: function(el, recurse, sType) {
                ...
                if (elListeners) {
                    for (var i = 0,
                    len = elListeners.length; i < len; ++i) {
                        var l = elListeners[i];
...
if (!YAHOO.util.DragDropMgr) {
    ...
    YAHOO.util.DragDrop.prototype = {
        ...
        removeInvalidHandleClass: function(cssClass) {
            for (var i = 0,
            len = this.invalidHandleClasses.length; i < len; ++i) {
        ...
        isValidHandleChild: function(node) {
            ...
            for (var i = 0,
            len = this.invalidHandleClasses.length; valid && i < len; ++i) {
